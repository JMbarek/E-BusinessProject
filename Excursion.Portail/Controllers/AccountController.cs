...
namespace Excursion.Portail.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LogOff()
        {
            ...
            ShoppingCartController.nbreTickets = 0;
            if (cartRepository.GetAll() != null)
            {
                foreach (Cart cart in cartRepository.GetAll().ToList())
                {
        ...
        public ActionResult Register()
        {
            ...
            SysLst2.Add("Client");
            SysLst2.Add("Client Indirect");
            SysLst2.Add("Responsable Service Excursions");
            ViewBag.Typeus = new SelectList(SysLst2);
            //ViewData["Typeus"] = new SelectList(SysLst2);

            var SysLst1 = new List<string>();
            SysLst1.Add("Guide");
            SysLst1.Add("Responsable Tour Operateur");
            SysLst1.Add("Representant Tour Operateur");
            SysLst1.Add("Receptionnaire");
            SysLst1.Add("Societe");
            ViewBag.TypeIndirc = new SelectList(SysLst1);
            //iewData["TypeIndirc"] = new SelectList(SysLst1);

            var SysLst3 = new List<int>();
            var SysQry3 = from d in centreRepository.GetAll()
                          select d.CentreID;
            SysLst3.AddRange(SysQry3.Distinct());
            ViewBag.Reg = new SelectList(SysLst3);
            //ViewData["Reg"] = new SelectList(SysLst3);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Register(Excursion.Portail.Models.Register2Model model, string TypeUser, string TypeCIndirect, int? CentreID, string PayEnLigne, List<string> Roles, List<string> Zones)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    Excursion.Data.User user = new Data.User();
                    user.Prenom = model.Prenom;
                    user.Nom = model.Nom;
                    user.Login = model.Login;

                    user.TypeUser = TypeUser;
                    user.TypeCIndirect = TypeCIndirect;
                    user.CentreID = CentreID;

                    user.Password = model.Password;
                    user.RoleResp = model.RoleResp;

                    user.CodeCIndirect = model.CodeCIndirect;
                    ...
                    user.TelephoneFix = model.TelephoneFix;
